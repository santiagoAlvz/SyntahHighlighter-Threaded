...
int main()
{
    unsigned char usera[30], userb[30], winner;
    int ival, jval;
...
again:
    ...
    if (winner) {
        printf("\n *** Congratulations Dear %s ,\n     You have won the game . !!!!", ((winner == 'X') ? usera : userb));
        goto end;
    }
...
repeat:
    fflush(stdin);
    printf("\n *** %s , Enter value (00-22) seperated by space :", (usertern == 0x00 ? usera : userb));
    scanf("%d%d", &ival, &jval);
